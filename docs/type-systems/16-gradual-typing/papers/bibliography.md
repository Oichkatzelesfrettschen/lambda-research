...
21. **Igarashi, A., Ozaki, S., Sekiyama, T., Tanabe, Y.** (2024). *Space-efficient polymorphic gradual typing, mostly parametric*. In Programming Language Design and Implementation (PLDI), pages 656-670.
    ...
    - **Repository**: https://github.com/EmericHo/gradual
...
|--------|------------|------------|----------|
| Gradualtalk | University of Chile |    - **Repository**: https://github.com/EmericHo/gradual | Gradual typing for Smalltalk |
   - **Repository**: https://doi.org/10.1145/2676726.2676971
...
- **Total papers in bibliography**: 67
- **Currently implemented**: 0
- **Awaiting implementation**: 67
