...
john : Record Person
john = [("name", "John"), ("age", 30), ("email", "john<span>@</span>example.com")]
...
- [Martin-Löf Type Theory](../../foundation/05-martin-lof-type-theory/index.md) - Constructive foundation
- [Calculus of Constructions](../../foundation/04-calculus-of-constructions/index.md) - Impredicative variant
- [Pure Type Systems](../12-pure-type-systems/index.md) - General framework
- [Refinement Types](../20-refinement-types/index.md) - Lightweight verification approach
