...
- [Linear Lambda Calculus](../06-linear-lambda-calculus/index.md) - Resource-aware foundation
- [Concurrent Variants](../../advanced/10-concurrent-variants/index.md) - Process calculi foundations
- [Substructural Types](../09-substructural-types/index.md) - General resource logics
- [Pi-Calculus](../../advanced/10-concurrent-variants/index.md) - Mobile process communication
