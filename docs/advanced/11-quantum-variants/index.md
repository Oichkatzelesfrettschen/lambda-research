...
- **Papers**: See [papers/bibliography.md](../../theory/29-homotopy-type-theory/papers/bibliography.md) for quantum computation foundations
...
- [Linear Lambda Calculus](../../type-systems/06-linear-lambda-calculus/index.md) - Resource-aware foundation
- [Substructural Types](../../type-systems/09-substructural-types/index.md) - Resource management principles
- [Concurrent Variants](../10-concurrent-variants/index.md) - Process calculi for quantum communication
- [Modal Types](../../type-systems/19-modal-types/index.md) - Quantum logic and necessity
