...
```
Terms: M, N ::= ... | M<span>@</span>l | here | there l
Locations: l ∈ Locations
Types: A ::= ... | A<span>@</span>l
```

#### Migration and Remote Execution
```
-- Execute computation at remote location
remote_exec : ∀l. (unit → α)<span>@</span>here → α<span>@</span>l
remote_exec f = (f ())<span>@</span>l
...
- **Papers**: See [papers/bibliography.md](../../theory/29-homotopy-type-theory/papers/bibliography.md) for concurrent calculi research
...
- [Session Types](../../type-systems/07-session-types/index.md) - Communication protocol types
- [Linear Lambda Calculus](../../type-systems/06-linear-lambda-calculus/index.md) - Resource-aware concurrency
- [Quantum Variants](../11-quantum-variants/index.md) - Quantum process calculi
- [Modal Types](../../type-systems/19-modal-types/index.md) - Distributed computation types
