...
- [Untyped Lambda Calculus](../../foundation/01-untyped-lambda-calculus/index.md) - Alternative computational foundation
- [Simply Typed Lambda Calculus](../../foundation/02-simply-typed-lambda-calculus/index.md) - Typed variant comparison
- [Linear Lambda Calculus](../../type-systems/06-linear-lambda-calculus/index.md) - Resource-aware alternatives
- [Pure Type Systems](../../type-systems/12-pure-type-systems/index.md) - Type system frameworks
