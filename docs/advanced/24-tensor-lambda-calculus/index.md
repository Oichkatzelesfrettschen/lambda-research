...
- **Historical**: Development of tensor computation and linear algebra in [historical/](../../papers/historical/church-lambda-calculus/1936_church_unsolvable_problem_oa.pdf)

## Related Systems

- [Linear Lambda Calculus](../../type-systems/06-linear-lambda-calculus/index.md) - Resource-aware computation foundation
- [Quantum Lambda Calculus](../22-quantum-lambda-calculus/index.md) - Quantum tensor networks
- [Effect Systems](../../type-systems/17-effect-systems/index.md) - Computational effects in numerical code
- [Dependent Types](../../type-systems/08-dependent-types/index.md) - Types depending on runtime values
