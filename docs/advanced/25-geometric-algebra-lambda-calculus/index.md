...
- **Tutorials**: Educational materials covering theory and practice in [tutorials/](../../foundation/04-calculus-of-constructions/index.md)
- **Historical**: Development of Clifford algebra and geometric computation in [historical/](../../papers/historical/church-lambda-calculus/1936_church_unsolvable_problem_oa.pdf)

## Related Systems

- [Linear Lambda Calculus](../../type-systems/06-linear-lambda-calculus/index.md) - Resource-aware computation foundation
- [Tensor Lambda Calculus](../24-tensor-lambda-calculus/index.md) - Multidimensional array computation
- [Quantum Lambda Calculus](../22-quantum-lambda-calculus/index.md) - Quantum geometric phases
- [Modal Types](../../type-systems/19-modal-types/index.md) - Geometric modalities and coordinate frames
