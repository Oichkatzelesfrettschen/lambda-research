...
- [Simply Typed Lambda Calculus](../02-simply-typed-lambda-calculus/index.md) - Adding type safety
- [Combinatory Logic](../../advanced/13-combinatory-logic/index.md) - Combinator-based equivalent
- [System F](../03-system-f-polymorphic/index.md) - Polymorphic extension
