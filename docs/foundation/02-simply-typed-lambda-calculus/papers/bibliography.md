...
**Clément, D. & Despeyroux, J. & Despeyroux, T. & Kahn, G.** (1986). *A Simple Applicative Language: Mini-ML*. Venue information needed.
- **Key Contribution**: Key contribution description needed
...
**Felleisen, M. & Friedman, D.P.** (1987). *Control Operators, the SECD-Machine, and the λ-Calculus*. In: 3rd Working Conference on the Formal Description of Programming Concepts.
- **Key Contribution**: Key contribution description needed
