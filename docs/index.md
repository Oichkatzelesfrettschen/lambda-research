...
This documentation supports comprehensive mathematical notation. For example:

$$\lambda x. x \quad \text{(identity function)}$$

$$\frac{\Gamma \vdash M : \sigma \to \tau \quad \Gamma \vdash N : \sigma}{\Gamma \vdash M N : \tau} \text{(application rule)}$$
