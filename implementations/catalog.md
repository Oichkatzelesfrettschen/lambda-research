...
**Idris Untyped Lambda Calculus**
- **Description**: An untyped lambda calculus implementation in Idris, demonstrating term representation, substitution with alpha-conversion, and beta-reduction.
- **Repository**: [Local implementation](/home/eirikr/lambda-research/implementations/idris)
- **Language**: Idris
- **Institution**: Local project
- **Key Features**: Dependently typed, explicit handling of variable binding and substitution.
- **Academic Relevance**: Showcases the use of dependent types for language implementation and verification.

**Scheme/Racket Untyped Lambda Calculus**
- **Description**: An untyped lambda calculus implementation in Racket, featuring robust substitution with alpha-conversion and a call-by-value evaluator.
- **Repository**: [Local implementation](/home/eirikr/lambda-research/implementations/scheme)
- **Language**: Racket (Scheme dialect)
- **Institution**: Local project
- **Key Features**: Symbolic manipulation, clear representation of AST, alpha-conversion.
- **Academic Relevance**: Demonstrates language implementation in a Lisp-like environment.

**Standard ML (SML) Untyped Lambda Calculus**
- **Description**: An untyped lambda calculus implementation in Standard ML, including algebraic data types for terms, substitution with alpha-conversion, and a call-by-value evaluator.
- **Repository**: [Local implementation](/home/eirikr/lambda-research/implementations/sml)
- **Language**: Standard ML
- **Institution**: Local project
- **Key Features**: Statically typed, algebraic data types, pattern matching.
- **Academic Relevance**: Illustrates lambda calculus implementation in a strict, statically typed functional language.

**Scala 3 Untyped Lambda Calculus**
- **Description**: An untyped lambda calculus implementation in Scala 3, utilizing modern Scala features for AST definition, free variable calculation, substitution with alpha-conversion, and beta-reduction.
- **Repository**: [Local implementation](/home/eirikr/lambda-research/implementations/scala)
- **Language**: Scala 3
- **Institution**: Local project
- **Key Features**: Expressive type system, functional programming paradigms, extension methods.
- **Academic Relevance**: Demonstrates lambda calculus implementation in a hybrid functional/object-oriented language.
